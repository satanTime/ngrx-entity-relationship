...
describe('toGraphQL', () => {
    ...
    it('generates query w/ injected string params', () => {
    ...
    it('generates query w/ object params', () => {
        const params = {
            id: '2',
        };
    ...
    it('generates query w/ comlex object params', () => {
        const params = {
            p1: '2',
            p2: true,
            p3: null,
    ...
    it('generates query w/o $ params when it is a string', () => {
        const params = {
            $: '2',
        };
        const query = toGraphQL('user', params, selectUser);
    ...
    it('generates query w/ $ params when it is an object', () => {
        const params = {
            $: {
                id: '$paramId',
                value: '$something',
    ...
    it('throws when values of $ param do not start with $', () => {
        const params = {
            $: {
                id: 'paramId',
            },
    ...
    it('combines string queries with aliases', () => {
    ...
    it('generates nicer query with ngrxGraphqlPrefix', () => {
